	...
	*/
	...
	$('a[id="add"]').click(function(){
		...
		function useReturnData(data){
		    ...
		    $("#content tr:last").after("<tr><td id='nombre-"+cont+"'>"+texto+"</td><td class='codigo'>"+valor+"<input type='hidden' name='codigo[]' value='"+valor+"'></td><td>"+per+"</td><td width='9%'><input  type='number' min='1' class='form-control' name='qty[]' id='qty-"+cont+"' required='' tabindex="+cont+1+"></td><td>"+param["par_unidad"]+"</td><td><input  type='number' min='1' class='form-control' name='cost[]' id='cost-"+cont+"' value='"+param["par_costo"]+"' required=''></td><td><input type='checkbox' class='form-control' name='update[]' id='update-"+cont+"' value='"+valor+"'></td><td width='7%'><input class='form-control' type='text' name='alicuota[]' id='alicuota-"+cont+"' value='12%' required=''></td><td><input class='form-control'  type='number' min='1' name='ivamonto[]' id='ivamonto-"+cont+"' required=''></td><td><input class='form-control'  type='number' min='1' name='costoProducto[]' id='costoProducto-"+cont+"' required=''></td><td><a href='#' class='btn btn-danger btn-sm' id='remove-"+cont+"'>Quitar</a></td></tr>");
		   	//boton de editar
