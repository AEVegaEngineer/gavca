...
<div class="row">
	<div class="form-group">
		...
		{!!link_to_route('parametro.index', $title = 'Volver', $parameters = $insumo->id, $attributes = ['class'=>'btn btn-primary'])!!}
	</div>
</div>
...
<div class="row">
	<div class="form-group">
		{!!Form::open(['route'=>['parametro.destroy',$insumo->id],'method'=>'DELETE'])!!}
