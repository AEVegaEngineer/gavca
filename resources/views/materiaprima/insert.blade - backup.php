...
@section('content')
	...
	@include('alerts.success')
		...
		<h3>Inserta cantidades de materias primas que ya estan registradas como parámetros</h3>
		...
		<div class="col-md-3"><a href="#" id="insertar-existente" class='btn btn-primary btn-sm margenBotLg'>Insertar Materia Prima</a></div>
		
		
		<div class="row">
			<div class="col-md-12">			
				<h3>Inserta cantidades de materias primas que deseas crear de cero</h3>
			</div>		
		</div>
